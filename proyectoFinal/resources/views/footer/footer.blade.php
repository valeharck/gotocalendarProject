        ...
        <div class="container text-center text-md-left">
            ...
            <div class="row text-center text-md-left mt-3 pb-3">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    <h6 class="text-uppercase mb-4 font-weight-bold">Go-To Calendar</h6>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p><i class="fa fa-home mr-3"></i> Barcelona, Spain, 08020</p>
            ...
            <div class="row py-3 d-flex align-items-center">
                ...
                <div class="col-md-8 col-lg-8">
                    <!--Copyright-->
                    <p class="text-center text-md-left grey-text">© 2018 Copyright: <strong> Go-ToCalendar.com</strong></p>
                    <!--/.Copyright-->
                </div>
                <!--Grid column-->
                <!--Grid column-->
